package com.xgc1986.xgc1986samples.adapter;
...
public class DemoAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    private ActivityHelper[] mDataset;
    ...
    public DemoAdapter(ActivityHelper[] myDataset) {
        mDataset = myDataset;
    }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder h, final int position) {
        ...
        if (position > 0) {
            ...
            int color = holder.mContent.getContext().getResources().getColor(mDataset[position].mColor);
            /** github button */
            Drawable githubDrawable = RippleDrawableHelper.createRippleDrawable(holder.mGithub, 0xfffafafa, color);
            ...
            /** Demo button */
            Drawable demoDrawable = RippleDrawableHelper.createRippleDrawable(holder.mContent, 0xfffafafa, color);
